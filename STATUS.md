...
- 判断当前优化的泛化能力
- 始终包含 baseline（fixed-256 + BM25）作为跨文档比较的参照系

### ◻️ Phase 4: 效果最终验证（待做）

- 在有 GPU 的机器上完成完整的 optimize-before/after 评估对比
- 验证查询改写+小块+重排序的全链路效果
...
### 检索指标演进（同一测试集 28 题，512chunk）

| 方案 | Recall@5 | Recall@10 | Precision@10 | MRR |
|------|:------:|:------:|:------:|:------:|
| ①纯向量 (Baseline) | 63.69% | 83.04% | 13.21% | 0.5217 |
| ②纯BM25 | 59.52% | 78.57% | 12.14% | 0.4455 |
| ③混合检索 (RRF) | 63.39% | 82.14% | 13.21% | 0.5515 |
| ④混合+重排序 | **89.29%** | **91.07%** | 14.29% | **0.7113** |
